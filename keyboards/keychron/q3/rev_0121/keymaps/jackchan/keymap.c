...
const uint32_t PROGMEM unicode_map[] = {
    [ALPHA] = 0x03B1, [BETA] = 0x03B2, [GAMMA] = 0x03B3, [GGAMMA] = 0x0393, [DELTA] = 0x03B4, [DDELTA] = 0x0394, [EPSILON] = 0x03B5, [ZETA] = 0x03B6, [ETA] = 0x03B7, [THETA] = 0x03B8, [TTHETA] = 0x0398, [IOTA] = 0x03B9, [KAPPA] = 0x03BA, [LAMBDA] = 0x03BB, [LLAMBDA] = 0x039B, [MU] = 0x03BC, [NU] = 0x03BD, [XI] = 0x03BE, [XXI] = 0x039E, [PI] = 0x03C0, [PPI] = 0x03A0, [RHO] = 0x03C1, [SIGMA] = 0x03C3, [SSIGMA] = 0x03A3, [TAU] = 0x03C4, [UPSILON] = 0x03C5, [PHI] = 0x03C6, [PPHI] = 0x03A6, [XHI] = 0x03C7, [PSI] = 0x03C8, [PPSI] = 0x03A8, [OMEGA] = 0x03C9, [OOMEGA] = 0x03A9,
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_all(
        KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_VOLD, KC_MUTE, KC_VOLU, KC_PSCR, KC_CALC, RGB_MOD,
        KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_DEL, KC_HOME, KC_PGUP,
        KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL, KC_END, KC_PGDN,
        CAPSWRD, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_RSFT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RCTL, KC_UP,
        KC_LCTL, KC_LCMD, KC_LALT, KC_SPC, KC_RALT, TO(WIN_GREEK), MO(WIN_FN), KC_RCPC, KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_GREEK] = LAYOUT_all(
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_7, KC_KP_8, KC_KP_9,
        ...
        KC_TRNS, XP(PSI, PPSI), X(ETA), X(EPSILON), X(RHO), X(TAU), XP(THETA, TTHETA), X(UPSILON), X(IOTA), XP(OMEGA, OOMEGA), XP(PI, PPI), KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_1, KC_KP_2, KC_KP_3,
        ...
        KC_LSFT, X(ZETA), XP(XI, XXI), X(XHI), KC_TRNS, X(BETA), X(NU), X(MU), KC_TRNS, KC_TRNS, KC_TRNS, KC_RSFT, KC_KP_0,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TO(WIN_BASE), KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_DOT, KC_TRNS),
};
